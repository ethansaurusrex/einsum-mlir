...
module {
  func.func @main(%arg0: !einsum.named_axes_tensor<["i","k"]:tensor<4x3xf32>>, %arg1: !einsum.named_axes_tensor<["k","j"]:tensor<3x4xf32>>, %arg2: !einsum.named_axes_tensor<["i","j"]:tensor<4x4xf32>>) -> () {
    einsum.hl ins(%arg0 , %arg1: !einsum.named_axes_tensor<["i","k"]:tensor<4x3xf32>>, !einsum.named_axes_tensor<["k","j"]:tensor<3x4xf32>>) outs(%arg2: !einsum.named_axes_tensor<["i","j"]:tensor<4x4xf32>>)
		{ equation = "ik,kj->ij" }      	
    return
  }
}
